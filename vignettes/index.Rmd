...
```{r igpre_bokeh, eval=TRUE, echo=TRUE, message=FALSE, lazy=TRUE}
...
save(facefit, smc_tr, bsfit, smc_tr_bs, facefit_hold,
  smc_tr_face_hold, bsfit_hold, smc_tr_bs_hold,
  file = "vignettes/data_cache/smc_fits.Rdata")
```

```{r fit5b, eval=TRUE, echo=FALSE}
load("data_cache/smc_fits.Rdata")
```
